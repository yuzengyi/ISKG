...
if not args.pretrained:
    ...
    model.load_state_dict(torch.load('./ISKG_model/bestModeParms-05-15-05-32.pth'.format(start_time)))
else:
    model.load_state_dict(torch.load("./ISKG_model/bestModeParms-05-15-05-32.pth"))
